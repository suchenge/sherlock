...
from modules.service.download.picture.page_url import PageUrl
from modules.service.download.picture.page_factory import PageFactory


class Creeper(object):
    def __init__(self):
        self.__threadCount__ = 10
